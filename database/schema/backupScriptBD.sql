...
--
-- Host: localhost:3306
-- Generation Time: Feb 13, 2021 at 02:23 AM
...
CREATE TABLE `adresses` (
  ...
  `nbCivic` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `rue` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `quartie` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
(4, '2021_02_13_015050_create_adresses_table', 1),
(5, '2021_02_13_020545_create_categories_table', 2);
...
--
ALTER TABLE `categories`
  MODIFY `idCategorie` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `adresses`
  ADD CONSTRAINT `adresses_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
