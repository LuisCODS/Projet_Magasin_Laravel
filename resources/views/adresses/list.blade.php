			...
			<table class="table table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="{{ route('edit-adresse', [$adresse->id]) }}" class="btn btn-primary">Editer</a></td>
						<td><a href="{{ route('destroy-adresse', [$adresse->id]) }}" class="btn btn-danger">Supprimer</a></td>
					</tr>
					@endforeach
				</tbody>
			</table>
