...
@section('title', 'Edit cat: ' . "{$categorie->nomCategorie}")
    <!-- ================================= Flash message =================================-->
    ...
    <div class="col-md-6 offset md-3">
        ...
        <form action="{{ route('update-categorie', [$categorie->id_categorie]) }}" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nomCategorie" value="{{ $categorie->nomCategorie }}"
                    name="nomCategorie" required>
            </div>
            <div class="form-group">
